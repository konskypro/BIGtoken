...
function clm2($ema, $count){
	...
	$bod = "email=".$ema."&password=%40Aq123456&referral_id=33A1ADLNH&monetize=1";
	$b = "email=".$ema."size".$count."@lifeguru.online&password=%40Aq123456&referral_id=33A1ADLNH&monetize=1";
...
echo $asciicode;
echo $cy."\nCre : ".$b."Han C_Gamer\n";
echo $w."Subscribe Yt : Han C_Gamer\n";
echo "\n";
echo $r."Start tool...\n".$g."Ready\n";
